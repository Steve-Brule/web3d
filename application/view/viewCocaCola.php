...
<html lang="en">
  ...
  <body id="bodyColor">
      ...
      <nav id="headerColor" class="navbar sticky-top navbar-expand-sm navbar_coca_cola">
            ...
            <div class="collapse navbar-collapse">
                ...
                <ul class="navbar-nav ml-auto">
                  ...
                  <!-- Dropdown -->
                  <li class="nav-item">
                      <a id="navModels" class="nav-link active"  href="#" data-toggle="popover" data-trigger="hover" data-placement="bottom" title="X3D Models" data-content="There are three X3D models: Coke, Sprite and Pepper">Models</a>
                  </li>
                  <li class="nav-item">
      ...
      <div class="container-fluid">
                          ...
                          <x3d id="wire">
                            <scene>
                                <Switch whichChoice="0" id='SceneSwitch'>
                                    ...
                                    <transform>
                                        <inline nameSpaceName="model" mapDEFToID="true" onclick="animateModel();" url="../application/assets/x3d/old_coke.x3d"> </inline>
                                    </transform>
                                    <transform>
          ...
          <div id="home" class="main_contents" style="display:none;">
